    ...
    module Registration
      class Verifier
        ...
        def perform
          ...
          Rails.logger.error('WebAuthn registration failed', exception: e)
          false
        end
        ...
        def create_user_verification!
          @user_verification = UserVerification.create!(user_account:, webauthn_credential:)
        end

        def create_user_credential_email!
          UserCredentialEmail.create!(user_verification:, credential_email:)
        end

        def user_account
          current_user_verification.user_account
        end
        ...
        def credential_email
          current_user_verification.user_credential_email.credential_email
        end
