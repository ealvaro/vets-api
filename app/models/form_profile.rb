...
class FormProfile
  ...
  ALL_FORMS = {
    ...
    edu: %w[22-1990 22-1990EMEB 22-1995 22-5490 22-5490E
            22-0993 FEEDBACK-TOOL 22-10203 22-1990EZ
  ...
  FORM_ID_TO_CLASS = {
    ...
    '10-7959F-2' => ::FormProfiles::VHA107959f2,
    '1010EZ' => ::FormProfiles::VA1010ez,
    '10182' => ::FormProfiles::VA10182,
    '10-8678' => FormProfiles::VA108678,
    ...
    '22-0839' => ::FormProfiles::VA0839,
    '22-0976' => ::FormProfiles::VA0976,
    '22-0989' => ::FormProfiles::VA0989,
