...
class SavedClaim::EducationCareerCounselingClaim < CentralMailClaim
  ...
  def send_to_benefits_intake!
    ...
    Rails.logger.warn(guid, attachment_id: guid, team: 'vfs-ebenefits')
  ...
  # https://va.ghe.com/software/vets-api/blob/master/lib/veteran_facing_services/notification_email.rb
