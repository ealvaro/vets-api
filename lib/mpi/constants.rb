...
module MPI
  module Constants
    ...
    CLEAR_FULL_IDENTIFIER = 'PN^200VCLR^USDVA^A'
    ...
    QUERY_IDENTIFIERS = [ICN = 'ICN', IDME_UUID = 'idme', LOGINGOV_UUID = 'logingov', MHV_UUID = 'mhv',
                         CLEAR_UUID = 'clear'].freeze
  end
end
