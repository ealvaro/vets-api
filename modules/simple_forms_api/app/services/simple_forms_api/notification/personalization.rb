        ...
        if first_name && date_submitted
          {
            ...
            if form.respond_to?(:notification_personalization)
              personalization.merge!(form.notification_personalization)
              personalization['date_expires'] = expiration_date if expiration_date
            end
