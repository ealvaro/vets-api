...
Note: The following command can currently only be run locally after following the [Native setup](https://va.ghe.com/software/vets-api/blob/master/docs/setup/native.md) instructions.
