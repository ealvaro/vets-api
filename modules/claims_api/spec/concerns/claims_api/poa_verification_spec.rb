...
describe ClaimsApi::PoaVerification do
  ...
  context 'validating poa_code for current_user' do
    ...
    shared_examples 'validating poa_code for current_user' do
      ...
      context 'when a single match is found by first/last name' do
        context 'when the poa_code matches' do
          before do
            create(rep_factory, representative_id: '12345', first_name:, last_name:,
      ...
      context 'when multiple matches are found by first/last name' do
        before do
          ...
          create(rep_factory, representative_id: '123456', first_name:, last_name:,
      ...
      context 'when multiple matches are found by first/last/middle name' do
        context 'when a single rep is found' do
          before do
            ...
            create(rep_factory, representative_id: '1234567', first_name:, last_name:,
                                middle_initial: 'A', poa_codes: ['091'], phone:)
          end
      ...
      context 'when the repʼs last name includes a suffix that matches the current userʼs suffix' do
        before do
          create(rep_factory, representative_id: '12345', first_name:, last_name: "#{last_name} III",
                              poa_codes: ['091'], phone:)
        end
    ...
    context 'when the claims accreditation tables flag is disabled' do
      ...
      include_examples 'validating poa_code for current_user'
    end
  ...
  context 'ambiguous rep scenario — two reps share a name and a POA code' do
    shared_examples 'ambiguous rep scenario behavior' do
      before do
        create(rep_factory, :vso,
    ...
    context 'when the claims accreditation tables flag is disabled' do
      ...
      include_examples 'ambiguous rep scenario behavior'
    end
