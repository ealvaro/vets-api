...
RSpec.describe 'ClaimsApi::V2::PowerOfAttorney::2122', type: :request do
  ...
  describe 'PowerOfAttorney' do
    ...
    before do
      create(rep_factory, representative_id: '999999999999',
    ...
    describe 'submit2122' do
      ...
      shared_examples 'submit2122 flag-sensitive behavior' do
            ...
            context 'when valid' do
              ...
              describe 'lighthouse_claims_api_poa_dependent_claimants feature' do
                ...
                it_behaves_like 'dependent claimant headers' do
                  let(:appoint_path) { appoint_organization_path }
                end
      ...
      context 'when the claims accreditation tables flag is disabled' do
        include_examples 'submit2122 flag-sensitive behavior'
      end
    ...
    describe 'validate2122' do
      shared_examples 'validate2122 flag-sensitive behavior' do
        context 'CCG (Client Credentials Grant) flow' do
          context 'when provided' do
            context 'when valid' do
      ...
      context 'when the claims accreditation tables flag is disabled' do
        include_examples 'validate2122 flag-sensitive behavior'
      end
