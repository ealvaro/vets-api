...
module ClaimsApi
  class Representative < ApplicationRecord
    ...
    self.table_name = 'claims_api_representatives'
    ...
    def self.find_within_max_distance(long, lat, max_distance = ::Veteran::Service::Constants::DEFAULT_MAX_DISTANCE)
      query = 'ST_DWithin(ST_SetSRID(ST_MakePoint(:long, :lat), 4326)::geography, claims_api_representatives.location, :max_distance)' # rubocop:disable Layout/LineLength
    ...
    def organizations
      ClaimsApi::Organization.where(poa: poa_codes)
    end

    def self.max_per_page
      ::Veteran::Service::Constants::MAX_PER_PAGE
    end
