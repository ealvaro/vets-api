    ...
    module Veterans
      class PowerOfAttorney::IndividualController < ClaimsApi::V2::Veterans::PowerOfAttorney::BaseController
        ...
        def validate_individual_poa_code!(poa_code)
          return if ClaimsApi::AccreditationTables.representative.where('? = ANY(poa_codes)', poa_code).any? &&
                    ClaimsApi::AccreditationTables.organization.find_by(poa: poa_code).blank?
