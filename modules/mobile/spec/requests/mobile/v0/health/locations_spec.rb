...
RSpec.describe 'Mobile::V0::Health::Locations', type: :request do
  ...
  describe 'GET /mobile/v0/health/locations/:id' do
    context 'when mhv_vaccine_mobile_return_empty_location_data feature flag is disabled' do
      before do
        allow(Flipper).to receive(:enabled?)
          .with(:mhv_vaccine_mobile_return_empty_location_data, anything).and_return(false)
      end
