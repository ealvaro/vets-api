...
describe IvcChampva::PdfCombiner do
  before do
    ...
    @image_path_non_existent = 'modules/ivc_champva/spec/fixtures/images/test_image_non_existent.pdf'
    @image_path_encrypted =
      'modules/ivc_champva/spec/fixtures/images/test-image-encrypted-with-lost-password.pdf'
