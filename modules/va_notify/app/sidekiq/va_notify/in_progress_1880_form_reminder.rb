...
module VANotify
  class InProgress1880FormReminder
    ...
    def perform(form_id)
      ...
      user_account_id = in_progress_form.user_account_id
    ...
    rescue ActiveRecord::RecordNotUnique, VANotify::Veteran::MPINameError, VANotify::Veteran::MPIError
      # RecordNotUnique: concurrent job already sent this reminder — safe to ignore
      nil
    end
  end
end
