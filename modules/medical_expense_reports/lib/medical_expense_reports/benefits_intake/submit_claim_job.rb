  ...
  module BenefitsIntake
    ...
    class SubmitClaimJob
      ...
      def update_form_submission_attempt
        ...
        Rails.logger.error(
          'MedicalExpenseReports::BenefitsIntake::SubmitClaimJob update_form_submission_attempt failed',
        ...
        begin
          ...
          Rails.logger.error(
            'MedicalExpenseReports::BenefitsIntake::SubmitClaimJob failed to enqueue UpdateFormSubmissionAttemptJob',
