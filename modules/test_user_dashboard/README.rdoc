...
## Usage
Test User Dashboard workflowys are used through a [standalone frontend application](https://va.ghe.com/software/vsp-test-user-dashboard), check frontend documentation for usage and local installation help. The production instance of the frontend application is hosted behind the SOCKS proxy; you will [need to have access to the SOCKS proxy](https://va.ghe.com/software/va.gov-team/blob/master/platform/working-with-vsp/orientation/request-access-to-tools.md#set-up-the-socks-proxy) to use it.
