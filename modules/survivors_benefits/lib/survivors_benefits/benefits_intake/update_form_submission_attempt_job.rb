  ...
  module BenefitsIntake
    ...
    class UpdateFormSubmissionAttemptJob
      ...
      sidekiq_retries_exhausted do |msg|
        Rails.logger.error(
          'SurvivorsBenefits::BenefitsIntake::UpdateFormSubmissionAttemptJob retries exhausted',
      ...
      def perform(saved_claim_id)
        ...
        if benefits_intake_uuid.blank?
          ...
          Rails.logger.error(
            'SurvivorsBenefits::BenefitsIntake::UpdateFormSubmissionAttemptJob found no ' \
