        ...
        KEY = {
          'claimantFullName' => {
            'first' => {
              ...
              key: 'form1[0].#subform[152].ClaimantsFirstName[0]'
            },
            'middle' => {
              limit: 1,
              question_num: 1,
              question_suffix: 'A',
              key: 'form1[0].#subform[152].ClaimantsMiddleInitial1[0]'
            },
            'last' => {
              limit: 18,
              question_num: 1,
              ...
              key: 'form1[0].#subform[152].ClaimantsLastName[0]'
            }
          },
          'claimantRelationship' => {
            key: 'form1[0].#subform[152].RadioButtonList[2]'
          },
          # 1b
          'claimantSocialSecurityNumber' => {
            'first' => {
              key: 'form1[0].#subform[152].ClaimantsSocialSecurityNumber_FirstThreeNumbers[0]'
            },
            'second' => {
              key: 'form1[0].#subform[152].ClaimantsSocialSecurityNumber_SecondTwoNumbers[0]'
            },
            'third' => {
              key: 'form1[0].#subform[152].ClaimantsSocialSecurityNumber_LastFourNumbers[0]'
            }
          },
          'claimantDateOfBirth' => {
            'month' => {
              key: 'form1[0].#subform[152].DOBmonth[1]'
            },
            'day' => {
              key: 'form1[0].#subform[152].DOBday[1]'
            },
            'year' => {
              key: 'form1[0].#subform[152].DOByear[1]'
            }
          },
          # 1d
          'claimantIsVeteran' => {
            key: 'form1[0].#subform[152].RadioButtonList[3]'
          },
          'claimantAddress' => {
            'street' => {
              limit: 30,
              ...
              key: 'form1[0].#subform[152].NumberStreet[0]'
            },
            'street2' => {
              limit: 5,
              question_num: 2,
              ...
              key: 'form1[0].#subform[152].Apt_Or_Unit_Number[0]'
            },
            'city' => {
              limit: 18,
              question_num: 2,
              ...
              key: 'form1[0].#subform[152].City[0]'
            },
            'state' => {
              key: 'form1[0].#subform[152].State_Province[0]'
            },
            'country' => {
              key: 'form1[0].#subform[152].Country[0]'
            },
            'postalCode' => {
              'firstFive' => {
                key: 'form1[0].#subform[152].Zip_Postal_Code[0]'
              },
              'lastFour' => {
                limit: 4,
                question_num: 2,
                ...
                key: 'form1[0].#subform[152].Zip_Postal_Code[1]'
              }
            }
          },
          'claimantPhone' => {
            'phone_area_code' => {
              key: 'form1[0].#subform[152].Telephone_Number_First_Three_Numbers[0]'
            },
            'phone_first_three_numbers' => {
              key: 'form1[0].#subform[152].Telephone_Number_Second_Three_Numbers[0]'
            },
            'phone_last_four_numbers' => {
              key: 'form1[0].#subform[152].Telephone_Number_Last_Four_Numbers[0]'
            }
          },
          'claimantInternationalPhone' => {
            key: 'form1[0].#subform[152].International_Telephone_Number[0]'
          },
          'claimantEmail' => {
            limit: 32,
            question_num: 2,
            ...
            key: 'form1[0].#subform[152].Email_Address_Optional[0]'
          },
          'claims' => {
            'DIC' => {
              key: 'form1[0].#subform[152].Dependency_And_Indemnity_Compensation_DIC[0]'
            },
            'survivorsPension' => {
              key: 'form1[0].#subform[152].Survivors_Pension[0]'
            },
            'accruedBenefits' => {
              key: 'form1[0].#subform[152].Accrued_Benefits[0]'
            }
          }
        }.freeze
