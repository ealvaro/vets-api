...
require 'survivors_benefits/structured_data/V2022/section_07'

RSpec.describe SurvivorsBenefits::StructuredData::V2022::Section07 do
  describe '#build_section7' do
    it 'merges combined NAME_LOC_MED_CENTER fields for each treatment' do
      form = {
        'treatments' => [
