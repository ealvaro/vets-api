...
require 'survivors_benefits/structured_data/V2025/section_02'

RSpec.describe SurvivorsBenefits::StructuredData::V2025::Section02 do
  describe '#build_section2' do
    it 'calls merge_name_fields' do
      ...
      expect(service).to receive(:merge_name_fields).with(form['claimantFullName'], 'CLAIMANT')
    ...
    describe 'when claimant phone and address country are present' do
      ...
      describe 'when claimant international phone is present' do
        it 'merges international phone number' do
          form = { 'claimantInternationalPhone' => '+52-5551234567' }
          service = SurvivorsBenefits::StructuredData::V2025::StructuredDataService.new(form)
          service.build_section2
          expect(service.fields).to include(
            'PHONE_NUMBER' => nil,
