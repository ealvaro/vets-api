...
describe PersonalInformationLogQueryBuilder do
  [
    ...
    [
      ...
      ' AND ("personal_information_logs"."created_at"' \
      " BETWEEN '2021-04-01 00:00:00' AND '2021-04-01 23:59:59.999999')"
    ],
    [
    ...
    [
      ...
      " WHERE (error_class ILIKE ANY (array['%hlr%']))" \
      ' AND ("personal_information_logs"."created_at"' \
      " BETWEEN '2021-03-01 00:00:00' AND '2021-03-31 23:59:59.999999')"
    ],
    [
